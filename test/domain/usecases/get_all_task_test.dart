...
void main() {
  late GetAllTask usecase;
  late MockRepository mockRepository;

  setUp(() {
    mockRepository = MockRepository();
    usecase = GetAllTask(mockRepository);
  });
  ...
  test('should get list of all task from the repository', () async {
    // arrange
    when(mockRepository.getAllTask('token'))
