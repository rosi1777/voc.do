...
void main() {
  late GetDoneTask usecase;
  late MockRepository mockRepository;

  setUp(() {
    mockRepository = MockRepository();
    usecase = GetDoneTask(mockRepository);
  });
  ...
  test('should get list of done task from the repository', () async {
    // arrange
    when(mockRepository.getDoneTask('token'))
