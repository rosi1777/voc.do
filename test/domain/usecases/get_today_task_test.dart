...
void main() {
  late GetTodayTask usecase;
  late MockRepository mockRepository;

  setUp(() {
    mockRepository = MockRepository();
    usecase = GetTodayTask(mockRepository);
  });
  ...
  test('should get list of today task from the repository', () async {
    // arrange
    when(mockRepository.getTodayTask('token'))
